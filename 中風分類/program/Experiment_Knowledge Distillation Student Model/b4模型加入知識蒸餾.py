...
Teacher: EfficientNetB4 → Student: ResNet20
...
TEACHER_PATH = r"C:\Users\User\OneDrive\Desktop\Special Topic\result\b4_result\best_finetuned_model.keras"
OUTPUT_DIR   = r"b4_distillation_result"
...
def get_student_model(input_shape=(380, 380, 3), num_classes=3):
...
def compare_models(teacher, student):
    ...
    print("模型參數比較")
    print("=" * 60)
    print(f"教師模型 (EfficientNetB4): {t_params:,} 個參數")
...
print("最終效能比較")
print("=" * 60)
print(f"教師模型 (EfficientNetB4) 準確率: {teacher_acc*100:.2f}%")
...
with open(report_path, 'w') as f:
    ...
    f.write("Teacher: EfficientNetB4 → Student: ResNet20\n")
    f.write("=" * 60 + "\n\n")
