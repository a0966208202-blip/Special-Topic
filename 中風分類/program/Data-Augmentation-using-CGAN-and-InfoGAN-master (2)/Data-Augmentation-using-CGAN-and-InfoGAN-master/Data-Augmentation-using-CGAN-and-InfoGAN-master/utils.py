...
from sklearn.metrics import precision_score, recall_score, f1_score, accuracy_score, confusion_matrix, \
    ConfusionMatrixDisplay # 將 plot_confusion_matrix 替換為 ConfusionMatrixDisplay
# --- 修改部分結束 ---
from torchvision.utils import make_grid

from CONSTANTS import Constants
# from plot_confusion_matrix import cm_analysis # 這個自定義函數現在可以不用了
...
def calculate_evaluation_metrics(y_true, y_pred, classes, save_path):
    ...
    # 使用新的 ConfusionMatrixDisplay 來繪製並儲存混淆矩陣
